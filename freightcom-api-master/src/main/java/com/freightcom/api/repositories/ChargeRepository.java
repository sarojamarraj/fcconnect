...
{
    Page<Charge> findByInvoiceId(@Param("invoice_id") Long invoice_id, Pageable pageable);
    Page<Charge> findByOrderId(@Param("order_id") Long order_id, Pageable pageable);
}
